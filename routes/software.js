...
const {getlocation,turnoffhardware,turnOnhardware,userexist,deletetheft,theftalert, userregistration, deleteuser, hardwarestatus, changestatus, latestnotification,allnotification,pinhistory} = require('../controllers/software');
